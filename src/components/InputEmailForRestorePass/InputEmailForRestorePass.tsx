...
export const InputEmailForRestorePass = () => {
    ...
    const message = `<div style="background-color: lime; padding: 15px">
                     password recovery link: <a href='http://localhost:3000/2.0/restorpassword/$token$'>link</a>
                     </div>`
    ...
    if(sendEmail) {
        return <Redirect to={"/restorpassword"}/>
    }
            ...
            <form className={stylesContainer.form}>
                <div className={stylesContainer.item}>
                    ...
                    <div className={stylesContainer.inputBlock}>
                        <input onChange={emailTarget} value={email} type="text" placeholder="example@ddd.com"/>
                    </div>
                </div>
